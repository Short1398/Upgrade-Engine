...
namespace UpgradeE
{
	...
	void WindowsWindow::Init(const WindowProps& props)
	{
		...
		//TODO Use Upgrade_Engine key codes, since its important to not be tied to GLFW when working with other platforms
	...
	{
		if (enabled) glfwSwapInterval(1);//Wait a frame before buffers are swapped
